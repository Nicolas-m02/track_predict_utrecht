...
sam_type = "small"  # Options: "large", "small"
...
class ReceiveImages:
    ...
    def connect(self, host=host_rec, port=port_rec):
        ...
        elif self.protocol.lower() == 'tcp' and not self.emulation:
        ...
        if self.zmq_prot:
            ...
            while True:
                ...
                if image is not None:
                    ...
                    #print(image['row_direction_cosines'])
                    #print(f"Row direction cosine: {math.degrees(math.atan2(image['row_direction_cosines'][1], image['row_direction_cosines'][0])):.2f}")
